        ...
        onSubmit: async (values, { setSubmitting }) => {
            ...
            try {
                ...
                if (isEditForm) {
                    ...
                    response = await axios.post('/posts/creat', formData);
                }
                ...
                <form onSubmit={formik.handleSubmit} encType="multipart/form-data">
                    <div className="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
                        ...
                        <div className="sm:col-span-2">
                            ...
                            />
                            {formik.errors.content && <p className="text-red-600 text-sm">{formik.errors.content}</p>}
                        </div>
                        <div className="sm:col-span-2">
                        ...
                        <div className="sm:col-span-2">
                            <label htmlFor="media" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Image</label>
                            <input
                                type="file"
                                name="media"
                                id="media"
